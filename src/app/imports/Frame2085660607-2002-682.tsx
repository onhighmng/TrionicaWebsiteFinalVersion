import svgPaths from "./svg-yu3tc1qkcb";

function Frame8() {
  return (
    <div className="content-stretch flex gap-[26px] items-start leading-[1.1] relative shrink-0 text-[20px] text-nowrap w-full">
      <p className="font-['Manrope:Bold',sans-serif] font-bold relative shrink-0 text-[#22282b]">{`Organic farm  `}</p>
      <p className="font-['Manrope:Medium',sans-serif] font-medium relative shrink-0 text-[#667085]">Automation farm</p>
      <p className="font-['Manrope:Medium',sans-serif] font-medium relative shrink-0 text-[#667085]">Bio-medical farm</p>
    </div>
  );
}
...
function Frame9() {
  return (
    <div className="content-stretch flex flex-col gap-[181px] items-start relative shrink-0 w-[494px]">
      <p className="capitalize font-['Manrope:Medium',sans-serif] font-medium leading-[1.2] relative shrink-0 text-[#22282b] text-[24px] tracking-[-1px] w-full">2025</p>
      <Frame8 />
    </div>
  );
}
...
function Frame2() {
  return (
    <div className="content-stretch flex font-['Manrope:SemiBold',sans-serif] font-semibold items-center justify-between leading-[1.1] relative shrink-0 text-[#22282b] text-[20px] text-nowrap w-[497px]">
      <p className="relative shrink-0">Harvesting Legacy.</p>
      <p className="relative shrink-0">Planting Tomorrow</p>
    </div>
  );
}
...
function Frame15() {
  return (
    <div className="content-stretch flex flex-col gap-[80px] items-start relative shrink-0 w-[714px]">
      <p className="capitalize font-['Manrope:Medium',sans-serif] font-medium leading-[1.2] min-w-full relative shrink-0 text-[#22282b] text-[48px] tracking-[-1px] w-[min-content]">Despite advances in agri-tech, traditional labor-intensive farming highlights ongoing inefficiencies.</p>
      <Frame2 />
    </div>
  );
}
...
function Frame4() {
  return (
    <div className="capitalize content-stretch flex font-['Manrope:SemiBold',sans-serif] font-semibold items-center justify-between leading-[1.2] relative shrink-0 text-[#22282b] text-[20px] text-nowrap w-full">
      ...
      <p className="relative shrink-0">Technology Irrigation</p>
    </div>
  );
}
...
function Frame5() {
  return (
    <div className="capitalize content-stretch flex font-['Manrope:SemiBold',sans-serif] font-semibold items-center justify-between leading-[1.2] relative shrink-0 text-[#22282b] text-[20px] text-nowrap w-full">
      ...
      <p className="relative shrink-0">{` Agricultural Monitoring`}</p>
    </div>
  );
}
...
function Frame18() {
  return (
    <div className="content-stretch flex items-start justify-between relative shrink-0 w-full">
      <div className="capitalize font-['Parkinsans:Medium',sans-serif] leading-none not-italic relative shrink-0 text-[#22282b] text-[38px] tracking-[-1px] w-[261px]">
        <p className="mb-0">{`Get `}</p>
        <p>Started Now</p>
      </div>
      <IconButton />
    </div>
...
function Frame3() {
  return (
    <div className="capitalize content-stretch flex font-['Manrope:SemiBold',sans-serif] font-semibold items-center justify-between leading-[1.2] relative shrink-0 text-[#22282b] text-[20px] text-nowrap w-full">
      ...
      <p className="relative shrink-0">Organic Fertilizer</p>
    </div>
  );
}
