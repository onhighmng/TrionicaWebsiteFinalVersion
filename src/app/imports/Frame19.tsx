...
function Button() {
  return (
    <div className="absolute bg-[#bbf814] content-stretch flex gap-[10px] h-[50px] items-center justify-center left-1/2 -translate-x-1/2 px-[33px] py-[15px] rounded-[35px] top-[269px] w-[198.145px]" data-name="Button">
...
function Section() {
  return (
    <div className="absolute contents left-0 top-0" data-name="Section 9">
      <Button />
      <p className="absolute font-['Manrope:Regular',sans-serif] font-normal leading-[1.55] left-[calc(50%+0.5px)] text-[#1c1716] text-[16px] text-center top-[124px] translate-x-[-50%] w-[534px]">Priorizamos a precisão e a inovação tecnológica para desbloquear novas fronteiras na inteligência geofísica, estabelecendo parcerias de alto nível para o desenvolvimento avançado de projetos mineiros.</p>
      <div className="absolute font-['Manrope:Medium',sans-serif] font-medium leading-[1.12] left-[calc(50%-10px)] text-[#1c1716] text-[48px] text-center top-0 tracking-[-1.44px] translate-x-[-50%] w-[515px]">
        <p className="mb-0">Tecnologia que Transforma a Mineração</p>
        <p>&nbsp;</p>
      </div>
    </div>
  );
