import svgPaths from "./svg-o8z6y664ek";
...
function Button1({ onNavigate }: { onNavigate?: (page: string) => void }) {
  return (
    <div
      className="absolute bg-[#6549f6] h-[62.4px] left-0 rounded-[34.353px] top-0 w-[305.581px] cursor-pointer hover:bg-[#5538d4] transition-colors pointer-events-auto"
      data-name="Button15"
      onClick={() => onNavigate?.('sobre-nos')}
    >
      <Paragraph7 />
...
function Button({ onNavigate }: { onNavigate?: (page: string) => void }) {
  return (
    <div
      className="absolute bg-white h-[62.4px] left-[326.38px] rounded-[34.353px] top-0 w-[255.613px] cursor-pointer hover:bg-gray-100 transition-colors pointer-events-auto"
      data-name="Button1"
