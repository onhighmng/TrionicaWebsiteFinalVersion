...
export function Testimonial({ testimonials }: TestimonialProps) {
  ...
  return (
    <div
      ref={containerRef}
      className="relative w-full max-w-5xl mx-auto py-20 px-8"
      style={{ cursor: "none" }}
    ...
    >
      ...
      <motion.div
        ...
        transition={{ duration: 0.3 }}
      >
        <span className="text-[10px] text-muted-foreground uppercase tracking-widest font-mono">Clique em qualquer lugar</span>
      </motion.div>
    </div>
  )
}