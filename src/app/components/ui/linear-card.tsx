...
import { XIcon, Plus, MousePointerClick } from 'lucide-react';
          ...
          <React.Fragment key={item.id}>
            ...
            >
              <DialogTrigger
                ...
                className='flex w-full flex-col overflow-hidden border bg-white hover:bg-gray-50 shadow-md hover:shadow-lg transition-all'
              >
                {/* Click icon on top left */}
                <div className='absolute top-3 left-3 z-10 p-2 bg-white/90 backdrop-blur-sm rounded-full shadow-md'>
                  <MousePointerClick className='w-4 h-4 text-[#2354a2]' />
                </div>
                ...
                <div className='flex flex-grow flex-row items-end justify-between p-4'>
                  <div>
                    <DialogTitle className='text-zinc-950 text-lg font-semibold'>
                      {item.title}
                    </DialogTitle>
                  </div>
                  <button className='absolute bottom-3 right-3 p-2 bg-[#2354a2] hover:bg-[#1a3f7f] rounded-full transition-colors'>
              ...
              <DialogContainer className='pt-20'>
                <DialogContent
                  ...
                  className='relative flex h-auto max-h-[85vh] mx-4 flex-col overflow-y-auto border bg-white shadow-2xl w-[calc(100%-2rem)]'
                >
                  <DialogImage
                    src={item.url.src}
                    alt={item.title}
                  ...
                  />
                  <div className='p-6'>
                    <DialogTitle className='text-3xl font-semibold text-zinc-950'>
                      {item.title}
                    </DialogTitle>
                  ...
                  <DialogClose className='text-zinc-950 bg-gray-200 p-3 hover:bg-gray-300 rounded-full transition-colors' />
                </DialogContent>
              </DialogContainer>
            </Dialog>
          </React.Fragment>
