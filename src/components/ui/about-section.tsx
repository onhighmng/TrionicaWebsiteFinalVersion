...
export default function AboutSection3({ headerClassName, className }: AboutSection3Props) {
          ...
          <div className="flex justify-between items-center mb-8 w-[85%] absolute lg:top-4 md:top-0 sm:-top-2 -top-3 z-10">
            <div className="flex items-center gap-2 text-xl">
              ...
              <TimelineContent
                ...
                className={`font-medium text-gray-600 ${headerClassName || 'text-sm'}`}
              >
                NOSSA HISTÓRIA
              </TimelineContent>
            </div>
          ...
          >
            ...
            >
              ...
              <image
                ...
                width={"100%"}
                height={"100%"}
                xlinkHref="https://images.unsplash.com/photo-1532187863486-abf9dbad1b69?w=1200&auto=format&fit=crop"
              ></image>
            </svg>
          </TimelineContent>
          ...
          <div className="flex flex-wrap lg:justify-start justify-between items-center py-3 text-sm">
            ...
            <div className="lg:absolute right-0 bottom-16 flex lg:flex-col flex-row-reverse lg:gap-0 gap-4">
              ...
              >
                ...
                <span className="text-gray-600 uppercase">áreas</span>
              </TimelineContent>
              <TimelineContent
                as="div"
                animationNum={7}
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="md:col-span-2">
            ...
            >
              ...
              >
                <p className="leading-relaxed text-justify">
                  Para além do fornecimento do Equipamento, prestamos serviços de Instalação e Treinamento para o bom uso dos equipamentos, oferecemos garantia e executamos serviços de manutenção dentro de todo o território nacional.
                </p>
              </TimelineContent>
            </TimelineContent>
          </div>
          ...
          <div className="md:col-span-1">
            <div className="text-right">
              ...
              >
                Equipamentos Laboratoriais | Soluções Científicas
              </TimelineContent>
              ...
              <TimelineContent
                ...
                className="mb-6"
              >
                <p className="text-gray-900 font-medium mb-4 text-justify leading-relaxed">
                  Possuímos diversos equipamentos de diagnóstico de avarias, reparação e calibração de equipamentos e ainda peças de reposição de excelente qualidade.
                </p>
                <blockquote className="bg-white border-l-4 border-red-500 p-4 italic text-gray-700 shadow-sm text-sm">
                  "Não vendemos caixas com equipamentos, vendemos <strong>SOLUÇÕES</strong>."
                </blockquote>
              </TimelineContent>
              ...
              >
                CONTACTAR <ArrowRight className="" />
              </TimelineContent>
            </div>
          </div>
        </div>
