  ...
  return (
    <div className="relative size-full">
      ...
      <div className="absolute left-1/2 -translate-x-1/2 top-0 w-[1167px] h-[904px]">
        ...
        <p className="absolute font-['Roboto:Regular',sans-serif] font-normal h-[69px] leading-[40px] left-[8px] text-[#1c1716] text-[32px] top-[246px] w-[590px]" style={{ fontVariationSettings: "'wdth' 100" }}>A infraestrutura necessária para converter desafios hídricos em novos ativos de desenvolvimento.</p>
      </div>
    </div>
  );
}