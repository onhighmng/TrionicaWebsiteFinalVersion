import svgPaths from "./svg-mo2j74ot3o";
...
function Ensino() {
  return (
    <div className="h-[130px] relative shrink-0 w-full" data-name="Ensino">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[26px] left-0 not-italic text-[#4a5565] text-[24px] text-justify top-[-0.59px] tracking-[-0.3125px] w-[611px]">Promovemos soluções sustentáveis que contribuem para a preservação ambiental, fornecendo equipamentos para laboratório e campo.</p>
    </div>
  );
}
...
function Content() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-[172px]" data-name="Content">
      <People />
      <p className="font-['Manrope:SemiBold',sans-serif] font-semibold leading-[1.15] relative shrink-0 text-[#1c1716] text-[20px] w-[188px]">Junte-se ao Futuro do ambiente.</p>
    </div>
  );
}
...
function Text1() {
  return (
    <div className="blur-[0px] filter h-[20px] relative shrink-0 w-[52.547px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative size-full text-[#4a5565] text-[32px] text-nowrap tracking-[-0.1504px]">
        <p className="absolute left-0 top-[0.5px]">Ambiente</p>
        <p className="absolute left-0 top-[0.5px]">Ambiente</p>
      </div>
    </div>
  );
...
export default function Frame() {
  return (
    <div className="relative size-full">
      ...
      <Container5 />
      <p className="absolute font-['Manrope:Medium',sans-serif] font-medium h-[133.509px] leading-[1.12] left-[8px] text-[#1c1716] text-[64px] top-[97px] tracking-[-1.92px] w-[536.414px]">Juntos pelo mundo verde.</p>
      <p className="absolute font-['Roboto:Regular',sans-serif] font-normal h-[69px] leading-[40px] left-[8px] text-[#1c1716] text-[32px] top-[257px] w-[590px]" style={{ fontVariationSettings: "'wdth' 100" }}>
