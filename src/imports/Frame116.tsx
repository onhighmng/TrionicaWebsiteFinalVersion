...
function ButtonNavButton({ onNavigate }: { onNavigate?: (page: string) => void }) {
  return (
    <div 
      className="absolute bg-[rgba(247,246,255,0.97)] h-[55.563px] left-[25.05px] rounded-[33.352px] top-[-6.98px] w-[89.094px] cursor-pointer hover:bg-[rgba(247,246,255,1)] transition-colors" 
...
function ButtonNavButton1({ onNavigate }: { onNavigate?: (page: string) => void }) {
  return (
    <div 
      className="absolute h-[22.234px] left-[158.62px] top-[9.04px] w-[96.859px] cursor-pointer hover:opacity-70 transition-opacity" 
...
function ButtonNavButton3({ onNavigate }: { onNavigate?: (page: string) => void }) {
  return (
    <div 
      className="absolute h-[22.234px] left-[453.15px] top-[9.04px] w-[80.797px] cursor-pointer hover:opacity-70 transition-opacity" 
...
function Navigation({ onNavigate }: { onNavigate?: (page: string) => void }) {
  return (
    <div className="absolute h-[41.594px] left-1/2 -translate-x-1/2 top-[30px] w-[559px]" data-name="Navigation2">
...
function Button({ onNavigate }: { onNavigate?: (page: string) => void }) {
  return (
    <div 
      className="content-center flex flex-wrap gap-[8px] h-[42px] items-center justify-center px-[20px] py-[16px] relative rounded-[24px] shrink-0 cursor-pointer hover:bg-white/10 transition-colors" 
      data-name="Button"
...
function ImageBg({ onNavigate }: { onNavigate?: (page: string) => void }) {
  return (
    <div className="absolute h-[775px] left-0 top-0 w-full max-w-[1440px]" data-name="Image BG">
      <div className="absolute h-[756px] left-0 right-0 top-0" data-name="Image BG">
        <img alt="" className="block max-w-none size-full object-cover" height="756" src={imgImageBg} width="1347" />
      </div>
...
function Paragraph3() {
  return (
    <div className="absolute h-[208px] left-[117.14px] top-[160px] w-[631.63px]" data-name="Paragraph52">
...
function Paragraph4() {
  return (
    <div className="absolute h-[72.797px] left-[117.14px] top-[403px] w-[655.472px]" data-name="Paragraph62">
...
function Button2({ onNavigate }: { onNavigate?: (page: string) => void }) {
  return (
    <div 
      className="absolute bg-[#6549f6] h-[62.398px] left-0 rounded-[34.353px] top-0 w-[305.578px] cursor-pointer hover:bg-[#5538d4] transition-colors" 
      data-name="Button12"
      onClick={() => onNavigate?.('sobre-nos')}
    >
      <Paragraph5 />
...
function Cta1({ onNavigate }: { onNavigate?: (page: string) => void }) {
  return (
    <div className="absolute h-[62.398px] left-[117.14px] top-[510.13px] w-[561.036px]" data-name="Cta">
...
function Slider({ onNavigate }: { onNavigate?: (page: string) => void }) {
  return (
    <div className="absolute contents left-0 top-0" data-name="Slider">
      ...
      <div className="absolute flex items-center justify-center right-[80px] top-[555.83px]">
...
function Group({ onNavigate }: { onNavigate?: (page: string) => void }) {
  return (
